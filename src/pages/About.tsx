  ...
  return (
    <div className="container mx-auto py-8 px-4">
      <div className="flex items-center justify-between mb-8">
        ...
        <h1 className="text-3xl font-bold">About ELDQM</h1>
      ...
      <Tabs defaultValue="documentation" className="w-full">
        ...
        <ScrollArea className="h-[calc(100vh-250px)]">
          <TabsContent value="documentation">
            <Card>
              <CardHeader>
                <CardTitle>Emergency Leakage and Dispersion Quantification Model (ELDQM)</CardTitle>
              ...
              <CardContent className="space-y-6">
                <div className="space-y-4">
                  ...
                  <p>
                    The Emergency Leakage and Dispersion Quantification Model (ELDQM) is a sophisticated software tool designed to model and simulate the dispersion of hazardous chemicals in the atmosphere. It provides critical information for emergency response planning, risk assessment, and safety protocol development in industrial settings.
                  </p>
                  <p>
          ...
          <TabsContent value="team">
            <Card>
              <CardHeader>
                ...
                <CardDescription>The team and resources behind ELDQM</CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                <div>
                    ...
                    <Card className="bg-background/50">
                      <CardContent className="pt-6">
                        ...
                        <ul className="mt-2 space-y-2">
                          <li>Muhammad Ahmad - Lead Developer</li>
                          <li>Alisha Naveed</li>
                          <li>Prof. Muhammad Imran Rashid</li>
                          <li>Mudassar Hussain</li>
                          <li>Dilsher Ahmad</li>
                        </ul>
                      </CardContent>
                    </Card>
                ...
                <div>
                  ...
                  <p className="mb-4">This project was developed with support from Chemical, Polymer and Composite Materials Engineering Department, University of Engineering and Technology, Lahore (New Campus), 39021, Pakistan </p>
                  <p>
                ...
                <div className="bg-slate-50 p-4 rounded-lg mt-6">
                  ...
                  <p className="text-sm">ELDQM Version 2.7.0</p>
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                <div>
                  ...
                  <p className="mt-2">
                    ELDQM utilizes a modified Gaussian plume dispersion model, which calculates the concentration of a chemical at any point downwind of a source based on:
                  </p>
                  ...
                  <div className="bg-slate-100 p-4 rounded-md mt-2 font-mono overflow-x-auto">
                ...
                <div>
                  ...
                  <p className="mt-2">
                    ELDQM is built using a modern web application architecture:
                  </p>
                  <ul className="list-disc pl-8 mt-2 space-y-1">
